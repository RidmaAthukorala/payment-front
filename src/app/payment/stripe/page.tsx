...
import Subscription from "../../Components/Payments/StripePayment/Subscription/index";
import { PaypalPayment } from "../../Components/Payments/PaypalPayment/index";
import CoinPayment from "../../Components/Payments/CoinPayment";
import OneTime from "../../Components/Payments/StripePayment/OneTime/index";
...
const PaymentPage = () => {
  ...
  return (
    <div className={styles.mainDiv}>
      <div>
        <div className={styles.title}>STRIPE SUBSCRIPTION PAYMENT</div>
        <div>
      ...
      <div>
        <div className={styles.title}>STRIPE ONE TIME PAYMENT</div>
        <div>
          <Elements stripe={stripePromise}>
            <OneTime />
          </Elements>
